...
<table>
<tr><th colspan="2">Modificar Grupo</th></tr>
<tr> 
<td>Id</td>
...
<input class="BotonesTeam" type="submit" name="btnmodificar" value="Modificar" onClick="javascript: return confirm('¿Deseas modificar este grupo?');">
</td>
</tr>
</table>
</form>
...
echo "<script>window.location= 'grupo_tabla.php?pag=$pagina' </script>";
